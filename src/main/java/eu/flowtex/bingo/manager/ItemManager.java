...
import eu.flowtex.bingo.utils.ItemSelector;
...
public class ItemManager
{
    ...
    public void start() {
        ...
        for (temp = ItemSelector.getItems(Main.getBingoManager().getBingosettings().getDifficulty(), Main.getBingoManager().getBingosettings().getItems()); temp.size() != Main.getBingoManager().getBingosettings().getItems(); temp = ItemSelector.getItems(Main.getBingoManager().getBingosettings().getDifficulty(), Main.getBingoManager().getBingosettings().getItems())) {}
                        ...
                        if (content != null) {
                            ...
                            if (itemsfromteam.contains(content.getType())) {
                                ...
                                if (itemsfromteam.size() == 0) {
                                    Main.getBingoManager().win(playerteam);
                                }
                            }
                        }
                    }
