...
public class Timer {
    ...
    public Timer() {
        ...
        String msg1 = ChatColor.translateAlternateColorCodes('&', Main.getInstance().getMessageConfiguration().getConfig().getString("lang.actionbarLobby").replace("%colorcode%", colorcode).replace("%gamename%", msg0));
