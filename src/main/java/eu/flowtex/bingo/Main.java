...
import eu.flowtex.bingo.commands.BingoCommand;
import eu.flowtex.bingo.commands.ItemsCommand;
import eu.flowtex.bingo.commands.ResetCommand;
import eu.flowtex.bingo.commands.TopCommand;
...
public final class Main extends JavaPlugin {
    ...
    public ChatColor CONVERTED_COLORCODE;
    ...
    public void onLoad() {
        ...
        if (this.getConfig().getBoolean("reset")) {
            ...
            this.getConfig().set("reset", (Object) false);
            this.saveConfig();
        }
    }
    ...
    public void onEnable() {
        ...
        //this.ColorCode();
        this.PREFIX = this.getConfig().getString("general.prefix");
        this.CONVERTED_COLORCODE = COLORCODE;
    ...
    //    final String colorcodeConfig = this.getConfig().getString("general.colorcode");
    //    if (colorcodeConfig == "§b") {
    //        CONVERTED_COLORCODE = ChatColor.AQUA;
    //    }
    //}
    ...
    public void startScoreboard() {
        ...
        ScoreboardUtils.insert(22, "");
        ScoreboardUtils.insert(21, "§bPlatzierung");
        ScoreboardUtils.insert(20, "§8➥ §7" + "-");
        ScoreboardUtils.insert(19, "");
        ScoreboardUtils.insert(18, "§bTeam");
        ScoreboardUtils.insert(17, "§8➥ §7" + "-");
        ScoreboardUtils.insert(16, "");
        ScoreboardUtils.insert(15, "§bVerbleibend");
        ScoreboardUtils.insert(14, "§8➥ §7" + "-");
        ScoreboardUtils.insert(13, "");
    }
