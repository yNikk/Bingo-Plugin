...
public class GameManager {
    ...
    private SetupManager bingosettings;
    ...
    public GameManager() {
        ...
        this.bingosettings = new SetupManager(1, 9, SetupManager.BingoDifficulty.NORMAL);
    ...
    public void win(final Team team) {
        ...
        Main.getTimer().information = "§bFate/Bingo §8» §7" + team.getTeamid() + " §7hat gewonnen!";
    }
